...
expName = '13-09-24 orient discrimination'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\vidna\\OneDrive\\Documents\\13-09-24 orient discr\\13-09-24 orient discrimination_lastrun.py',
